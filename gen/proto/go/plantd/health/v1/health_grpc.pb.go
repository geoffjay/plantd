...
const (
	HealthService_Check_FullMethodName = "/plantd.health.v1.HealthService/Check"
	HealthService_Watch_FullMethodName = "/plantd.health.v1.HealthService/Watch"
)
...
type HealthServiceClient interface {
	...
	Watch(ctx context.Context, in *HealthWatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HealthCheckResponse], error)
}
...
func (c *healthServiceClient) Watch(ctx context.Context, in *HealthWatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HealthCheckResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HealthService_ServiceDesc.Streams[0], HealthService_Watch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HealthWatchRequest, HealthCheckResponse]{ClientStream: stream}
...
type HealthServiceServer interface {
	...
	// Watch service health changes
	Watch(*HealthWatchRequest, grpc.ServerStreamingServer[HealthCheckResponse]) error
...
func (UnimplementedHealthServiceServer) Watch(*HealthWatchRequest, grpc.ServerStreamingServer[HealthCheckResponse]) error {
...
func _HealthService_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HealthServiceServer).Watch(m, &grpc.GenericServerStream[HealthWatchRequest, HealthCheckResponse]{ServerStream: stream})
}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "plantd.health.v1.HealthService",
	...
	Metadata: "plantd/health/v1/health.proto",
}
